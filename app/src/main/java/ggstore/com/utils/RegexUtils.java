...
public final class RegexUtils {
     ...
     class RegexConstants {
        ...
        public static final String REGEX_MOBILE_8 = "\\d{8}$";
        /**
    ...
    public static boolean isMobileSimple_8(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_MOBILE_8, input);
    }
    /**
