...
public class PayPalHelper {
    ...
    //你所注册的APP Id
    private static final String CONFIG_CLIENT_ID = "AXBPxBEELrnhswCPPjE_P0SkuD_FbyOYGN4LCPQnkG8U3k1bwLMDwURnbvKI6lokkKKSRiIVQjWSBws8";
...
//.merchantUserAgreementUri(Uri.parse("https://www.example.com/legal"));
    ...
    private PayPalPayment getStuffToBuy(String paymentIntent) {
        ...
        PayPalItem[] items =
                {
                        new PayPalItem("sample item #1", 2, new BigDecimal("1"), "USD",
                                "sku-12345678"),
                        new PayPalItem("free sample item #2", 1, new BigDecimal("1.00"),
                                "USD", "sku-zero-price"),
                        new PayPalItem("sample item #3 with a longer name", 1, new BigDecimal("0.99"),
                                "USD", "sku-33333")
                };
