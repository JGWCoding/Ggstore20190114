...
public class TodayDiscountRecyclerFragment extends BaseRecyclerViewFragment {
    @Override
    protected void requestData(final boolean isRefreshing) { //true 为刷新 false 为加载更多
        ...
        if (isRefreshing) {
            ...
            AppOperator.runOnThread(new Runnable() {
                @Override
                public void run() {
                    String url = Constent.url_today_discount + "&p=" + page;
    ...
    protected RecyclerView.LayoutManager getLayoutManager() {
        TodayDiscountFragment fragment = (TodayDiscountFragment) getParentFragment();
    ...
    class CourseAdapter extends BaseRecyclerAdapter<NewProductBean> {
        ...
        protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, final NewProductBean item, int position) {
            ...
            ImageLoader.loadImage(TodayDiscountRecyclerFragment.this.getContext(), ((MyViewHolder) holder).imgDetail, Constent.base_images_url + item.getPictureL());
