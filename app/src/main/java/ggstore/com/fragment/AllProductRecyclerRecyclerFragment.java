...
public class AllProductRecyclerRecyclerFragment extends BaseRecyclerViewFragment {
                ...
                public void run() {
                    ...
                    OkHttpManager.getAsync(url, new OkHttpManager.DataCallBack() {
                        ...
                        public void requestFailure(Request request, Exception e) {
                            ToastUtil.showToast(R.string.state_network_error);
                            onRequestError();
                        }
    ...
    protected RecyclerView.LayoutManager getLayoutManager() {
        AllProductFragment fragment = (AllProductFragment) getParentFragment();
