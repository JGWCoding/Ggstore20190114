...
public class BabyChildrenRecyclerRecyclerFragment extends BaseRecyclerViewFragment {
    ...
    protected void requestData(final boolean isRefreshing) { //true 为刷新 false 为加载更多
        ...
        if (isRefreshing) {
            ...
            AppOperator.runOnThread(new Runnable() {
                @Override
                public void run() {
                    String url = Constent.url_baby_children + "&p=" + page;
    ...
    protected RecyclerView.LayoutManager getLayoutManager() {
        BabyChildrenFragment fragment = (BabyChildrenFragment) getParentFragment();
    ...
    class CourseAdapter extends BaseRecyclerAdapter<NewProductBean> {
        ...
        protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, final NewProductBean item, int position) {
            ...
            ImageLoader.loadImage(BabyChildrenRecyclerRecyclerFragment.this.getContext(), ((MyViewHolder) holder).imgDetail, Constent.base_images_url + item.getPictureL());
